...
// person or a conversation. Read by the places that must treat the
// assistant's own agents differently from the humans it serves —
// notification attribution, and the inter-bot message graph.
